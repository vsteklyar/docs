...
<CardGroup cols={2}>
  <Card title="Platform Installer" icon="pen-to-square" href="https://mintlify.com/docs/installation.mdx">
    Learn how to set up the Aiphoria Platform in your environment
  </Card>
